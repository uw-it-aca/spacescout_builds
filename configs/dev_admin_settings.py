...
DATABASES = {
    'default': {
        ...
        'NAME': 'admin_proj/admin.db',                      # Or path to database file if using sqlite3.
...
SPOTSEEKER_AUTH_MODULE = 'spotseeker_admin.auth.oauth'
...
SECRET_KEY = 'hvsg7p*7#9o3=@&amp;pcbk*4$^l4@su#_q-xoqh-id(z@)u4^ng@^'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    'admin_proj/spotseeker_admin/templates'
)
